...
| cooldownMs | number | 3000 | 500 | 10000 | Cooldown between orders per leg (ms) |
| sellThreshold | number | 0.75 | 0.60 | 0.95 | Price above which to sell leading leg for profit-taking |
